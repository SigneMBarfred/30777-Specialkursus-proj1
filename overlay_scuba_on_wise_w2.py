...
for obj in idno:
    ...
    try:
        ...
        hdu_wise = fits.open('C:/Users/signe/Documents/DTU/Specialkursus_radiogal/cutout_wise_w2_id_' 
                                + str(int(obj)) + '.fits')
        ...
        ax_wise.set_title('WISE W2 map of Obj_id' + str(int(obj)) )
        ...
        plt.savefig('scuba_overlay_wise_w2_id_' + str(int(idno[count])) + '.png')
