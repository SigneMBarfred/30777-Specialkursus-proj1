# -*- coding: utf-8 -*-
"""
Created on Mon Dec 11 15:51:02 2023
...
for obj in idno:
    ...
    try:
        ...
        hdu_spitzer = fits.open('C:/Users/signe/Documents/DTU/Specialkursus_radiogal/cutout_spitzer_ch1_id_' 
                                + str(int(obj)) + '.fits')[0]
        data_spitzer = hdu_spitzer.data
        hdr_spitzer = hdu_spitzer.header
        ...
        hdu_scuba = fits.open('C:/Users/signe/Documents/DTU/Specialkursus_radiogal/scuba_cutout_'
                              + str(obj) +'.fits')[0]
        scuba850_data_cube = hdu_scuba.data  # This is a 3D cube
        scuba_data = scuba850_data_cube
        hdr_scuba = hdu_scuba.header
        ...
        norm = colors.SymLogNorm(linthresh=0.5, linscale=3.5, vmin=vmin, vmax=vmax)
        ...
        ax_spitzer.set_title('IRAC Ch1 map of Obj_id' + str(int(obj)) + ' \n at ' + 
                             str(positions[count]) + '\n'+'contours from SCUBA 850 $\mu$ m snr')
        #ax_spitzer.contour(scuba_data, levels=levels, colors='blue',alpha=0.5)
      
        
        ax_spitzer.contour(hdu_scuba.data[0],
                           transform=ax_spitzer.get_transform(WCS(hdu_spitzer.header)),
                           levels=levels,
                           colors='blue', 
                           linewidths=0.5)
        ...
        circle = SphericalCircle(loc, (15/3600)*u.deg, transform=ax_spitzer.get_transform('fk5'),edgecolor='black',facecolor='None')
